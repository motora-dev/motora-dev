...
@Component({
  ...
  template: `
    <div class="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <h1 class="text-8xl font-bold text-gray-200">401</h1>
      <h2 class="mt-4 text-2xl font-semibold text-gray-700">{{ 'error.401.title' | translate }}</h2>
      <p class="mt-2 text-center text-gray-500">{{ 'error.401.message' | translate }}</p>
